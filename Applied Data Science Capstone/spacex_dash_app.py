...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=site_counts.values, 
...
def get_scatter_plot(entered_site, entered_weight):
    filtered_df = spacex_df
    min_weight, max_weight = entered_weight
    print(min_weight)
    if entered_site == 'ALL':
        filtered_df = spacex_df[spacex_df['Payload Mass (kg)'] >= min_weight]
        ...
        filtered_df = spacex_df[(spacex_df['Launch Site'] == entered_site) & spacex_df['Payload Mass (kg)'] >= min_weight]
        # return the outcomes piechart for a selected site
